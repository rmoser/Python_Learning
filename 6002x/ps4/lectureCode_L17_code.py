...
def fitData(fileName):
    ...
    pylab.plot(xVals, estYVals, label = 'Linear fit, k = '
               + str(round(k, 5)) + " Rsq: " + str(round(rsq, 3)))
...
def fitData1(fileName):
    ...
    estYVals = a*xVals + b
    rsq = rSquare(yVals, estYVals)
    pylab.plot(xVals, estYVals, label = 'Linear fit' + " Rsq: " + str(round(rsq, 3)))
    a,b,c,d = pylab.polyfit(xVals, yVals, 3)
    estYVals = a*(xVals**3) + b*xVals**2 + c*xVals + d
    rsq = rSquare(yVals, estYVals)
    pylab.plot(xVals, estYVals, label = 'Cubic fit' + " Rsq: " + str(round(rsq, 3)))
    pylab.legend(loc = 'best')
...
#    rsq = rSquare(yVals, estYVals)
    rsq = -1
    pylab.plot(extX, estYVals, label = 'Linear fit' + " Rsq: " + str(round(rsq, 3)))
    a,b,c,d = pylab.polyfit(xVals, yVals, 3)
    estYVals = a*(extX**3) + b*extX**2 + c*extX + d
#    rsq = rSquare(yVals, estYVals)
    rsq = -1
    pylab.plot(extX, estYVals, label = 'Cubic fit' + " Rsq: " + str(round(rsq, 3)))
    pylab.legend(loc = 'best')
